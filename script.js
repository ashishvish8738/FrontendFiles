function modifyArray(arr, callback) {function modifyArray(arr, callback)function modifyArray(afunction modifyArray(arr, callback)  {function modifyArray(arr, callback) {function modifyArray(arr, callback) {
  ...
  function modifyArray(afunction modifyArray(arr, callback) {function modifyArraymodifyArray(afunction modifyArray(arr, callbackmodifyArray(afunction modifyArray(arr, callback(arr, callback) {function modifyArray(arr, callback) {function modifyArray(arr, callback) {
